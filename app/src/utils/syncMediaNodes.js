      ...
      if (pendingLayerIds.has(layerId)) {
        ...
        collectedLayers.push({
          ...
          data: {
            ...
            displayX: outputData.displayX || node.data?.displayX,
            displayY: outputData.displayY || node.data?.displayY,
            displayWidth: outputData.displayWidth || node.data?.displayWidth,
            displayHeight: outputData.displayHeight || node.data?.displayHeight,
